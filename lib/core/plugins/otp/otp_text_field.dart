...
import 'package:taxi_booking/core/plugins/otp/cursor_painter.dart';
import 'package:taxi_booking/core/plugins/otp/haptic_feedback_type.dart';
...
// selects the right fill color for the field
  ...
  Future<void> _showPasteDialog(String pastedText) {
    ...
    return showDialog(
      ...
      builder: (context) => _dialogConfig.platform == Platform.isIOS
  ...
  List<Widget> _getActionButtons(String pastedText) {
    ...
    // ignore: unrelated_type_equality_checks
    if (_dialogConfig.platform == Platform.isIOS) {
      resultList.addAll([
